...
version = "$Id: bootstrap.py 4376 2020-03-19 21:27:06Z toby $"
...
if help:
  ...
  bootstrap.py options:
    ...
    --noinstall skip post-install, such as creating run shortcuts
...
def BailOut(msg):
    ...
    if showWXerror:
        ...
        print("BOOTSTRAP WARNING: ",file=sys.stderr)
        for line in msg.split('\n'):
            print(line,file=sys.stderr)
        print("Recreate this using command:")
        print("     {} {} {}".format(
...
if missing and not skipInstallSteps:
...
if allBinaries and not skipDownloadSteps:
