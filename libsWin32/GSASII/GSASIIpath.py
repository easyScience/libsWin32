...
# $Date: 2020-11-04 01:19:08 +0100 (Wed, 04 Nov 2020) $
# $Author: toby $
# $Revision: 4645 $
# $URL: https://subversion.xray.aps.anl.gov/pyGSAS/trunk/GSASIIpath.py $
# $Id: GSASIIpath.py 4645 2020-11-04 00:19:08Z toby $
########### SVN repository information ###################
'''
...
def SetVersionNumber(RevString):
    ...
    :param str RevString: something like "$Revision: 4645 $"
      that is set by subversion when the file is retrieved from subversion.

    Place ``GSASIIpath.SetVersionNumber("$Revision: 4645 $")`` in every python
    file.
    '''
    try:
